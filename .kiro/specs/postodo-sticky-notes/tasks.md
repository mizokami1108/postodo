...
- [x] 9. 同期リトライ機能の強化
  - [x] 9.1 指数バックオフリトライの実装
    - 失敗時に 1秒、2秒、4秒 の間隔でリトライ
    - 最大3回まで
    - _Requirements: 7.4_
  - [x] 9.2 プロパティテスト: リトライ動作
...
- [x] 10. データ復元時の整合性検証
  ...
  - [x] 10.2 プロパティテスト: データ復元の整合性
    - **Property 15: データ復元時の整合性検証**
    - **Validates: Requirements 11.2, 11.3**

- [x] 11. 既存機能のプロパティテスト追加
  - [x] 11.1 プロパティテスト: 付箋作成時のファイル生成
    - **Property 1: 付箋作成時のファイル生成**
    - **Validates: Requirements 1.3, 1.4**
  - [x] 11.2 プロパティテスト: 空コンテンツの作成拒否
    - **Property 2: 空コンテンツの作成拒否**
    - **Validates: Requirements 1.5**
  - [x] 11.3 プロパティテスト: UI変更のファイル同期
    - **Property 5: UI変更のファイル同期（ラウンドトリップ）**
    - **Validates: Requirements 2.2, 7.1**
  - [x] 11.4 プロパティテスト: ファイル変更のUI同期
    - **Property 6: ファイル変更のUI同期**
    - **Validates: Requirements 2.3, 7.2**
  - [x] 11.5 プロパティテスト: ドラッグ位置の境界制限
    - **Property 7: ドラッグ位置の境界制限**
    - **Validates: Requirements 3.4**
  - [x] 11.6 プロパティテスト: 削除時のファイル削除
    - **Property 9: 削除時のファイル削除**
    - **Validates: Requirements 5.2**
  - [x] 11.7 プロパティテスト: 外観変更の永続化
    - **Property 10: 外観変更の永続化**
    - **Validates: Requirements 6.3, 6.4**

- [x] 12. DIコンテナとイベントバスのプロパティテスト
  - [x] 12.1 プロパティテスト: シングルトン保証
    - **Property 16: DIコンテナのシングルトン保証**
    - **Validates: Requirements 12.1, 12.3**
  - [x] 12.2 プロパティテスト: 依存関係解決
    - **Property 17: DIコンテナの依存関係解決**
    - **Validates: Requirements 12.2**
  - [x] 12.3 プロパティテスト: イベントパターンマッチング
